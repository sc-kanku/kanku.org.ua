  ...
  return (
        <>
            <div className="mt-2 alert alert-info border border-info">
                ...
                Якщо ви вже знаходитесь в процесі створювання іншого нового спортсмена, то спочатку треба переключитись на якийсь інший екран.
                І нема синхронізації з загальним списком - потрібно рефрешнути сторінку, щоб новостворений спортсмен з'явився в таблиці.
                </div>
            ...
            <div className="collapse mt-2 alert alert-warning border border-warning" id="collapseExample">
                <ul>
                    ...
                    <li className="alert-heading">
                        ...
                        <ol>
                            <li>Додавання нового спортсмена працює, але якщо ви вже знаходитесь в процесі створювання іншого нового спортсмена, то спочатку треба переключитись на якийсь інший екран.</li>
                            <li>І нема синхронізації з загальним списком - потрібно рефрешнути сторінку, щоб новостворений спортсмен з'явився в таблиці.</li>
                ...
                <li className="alert-heading">
                    ...
                    <ol>
                        <li>Додавання нового залу / новини</li>
                        <li>Видалення (чи справді потрібно?) спортсмена / залу / новини (можливо тільки недавноствореного?)</li>
